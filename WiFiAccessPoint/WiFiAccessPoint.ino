...
// HTML master
char HTML[] = "<html><body><h1>Funcionando a encrenca</h1><h2>SmartTechSystems</h2><a href=\"http://192.168.4.1/1\">Página 1 </a><button><a href=\"toggle\">Alterar LED</a></button></body></html>";
